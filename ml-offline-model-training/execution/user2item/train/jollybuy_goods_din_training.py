...
from src_v2.factory.jollybuy.jollybuy_goods_user2item import JollybuyGoodsUser2ItemLearn2RankDINFactory
...
if __name__ == '__main__':
    ...
    # basic option
    opt.experiment_name = '57dc4d3f4ad149a7b025d02c53205c3e'
    ...
    if opt.monitoring:
        ...
        baseline_factory = JollybuyGoodsUser2ItemLearn2RankDINFactory(mode='validation', col2label2idx=base_col2label2idx,
                                                            use_cuda=True, model_path=os.path.join(jb_goods_u2i_din_factory.config.BASELINE_MODEL_PATH, base_model_path),
                                                            **vars(opt))
