...
from src_v2.factory.planet_news.planet_news_user2item import PlanetNewsUser2ItemDINFactory
...
if __name__ == '__main__':
    ...
    model_factory = PlanetNewsUser2ItemDINFactory(mode='train', use_cuda=True, **vars(opt))
    ...
    if opt.monitoring:
        ...
        baseline_factory = PlanetNewsUser2ItemDINFactory(mode='validation',
