...
from src_v2.preprocess.base import BaseUser2ItemPreprocessor, BaseItem2ItemPreprocessor, BaseHotPreprocessor
...
class CTRRankerFactory(metaclass=ABCMeta):
    ...
    def initialize(self, mode: str, col2label2idx: dict = None, **kwargs):
        ...
        elif self.config.SERVICE_TYPE == 'hot':
            obj_preprocessor = BaseHotPreprocessor
