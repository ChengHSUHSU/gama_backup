...
from src.gcsreader.udf import udf_set_user_profile_join_date, udf_get_date_from_timestamp
...
class UserProfileReader(GcsReader):
    ...
    def process(self, content_type: str, profile_type: str = 'category', user_profile_run_time: str = None):
        ...
        print('user_profile_run_time : ', user_profile_run_time)
        ...
        df = df.withColumn('date', udf_get_date_from_timestamp()(f.col('updateTime')))
