...
class JollybuyGoodsHotItemsConfig(BaseConfig):
    ...
    # used by `filter_dataframe`
    TARGET_EVENT = {
        'input_data_pool': ['jb_merchant_content_click', 'jb_goods_content_click', 'jb_category_content_click', 'jb_search_content_click', 'jb_home_page_content_click', 'funmart_content_click', 'jb_goods_item_click',
                            'jb_merchant_content_impression', 'jb_goods_content_impression', 'jb_cart_content_impression', 'jb_category_content_impression', 'jb_search_content_impression', 'jb_home_page_content_impression', 'funmart_content_impression',
                            'jb_goods_page_view'],
    }
    ...
    COUNT_FILTER_CONDITIONS = {'impression': {'jb_merchant_content_impression': ['impression_info', 'page_info', 'uuid', 'page', ['jb_store', 'jb_store_category', 'jb_merchant_search'], True],
                                              ...
                                              'funmart_content_impression': ['impression_info', 'impression_info', 'uuid', 'cat', ['jbitem'], True]},
                               'click': {'jb_merchant_content_click': ['click_info', 'click_info', 'uuid', 'sec', ['tv_wall'], False],
                                         ...
                                         'funmart_content_click': ['click_info', 'click_info', 'uuid', 'cat', ['jbitem'], True]},
