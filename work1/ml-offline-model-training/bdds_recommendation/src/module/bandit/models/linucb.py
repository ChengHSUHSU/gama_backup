...
from bdds_recommendation.src.module.bandit.utils.numba_helper import numba_dot, numba_identity, numba_sqrt, \
...
class NumbaLinUBC():
    ...
    def train(self, data: pd.DataFrame, epochs: int, n_visits: int, shuffle: bool = True,
              arm_col: str = 'uuid', candidate_col: str = 'uuids', reward_col: str = 'reward', warmup_iters: int = 0):
        '''Train method
