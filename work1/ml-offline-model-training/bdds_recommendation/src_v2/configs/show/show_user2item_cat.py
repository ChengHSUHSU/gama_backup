...
ShowUser2ItemDINModelConfig = BaseDINConfigs.update({
    ...
    'DENSE_FEATURE_SIZE': {
            ...
            'planet_news_used': 1, 'planet_comic_used': 1,
            'planet_novel_used': 1, 'game_used': 1, 'gamapay_used': 1, 'gash_used' : 1
    },
...
ShowUser2ItemDINPreprocessConfig = BaseUser2ItemPreprocessConfigs.update({
    ...
    'CATEGORY_PREF_SCORE_PROCESS': [{'level': ['click', 'cat0'], 'cat_col': 'user_category', 'score_col': 'cat0_pref_score'},
                                    {'level': ['click', 'cat0'], 'cat_col': 'club_user_category', 'score_col': 'club_cat0_pref_score'}],
    ...
    # required columns
    'REQUISITE_COLS': [
        'popularity_score','cat0_pref_score', 'club_cat0_pref_score',
