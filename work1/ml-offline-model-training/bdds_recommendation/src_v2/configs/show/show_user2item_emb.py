...
'''
        'planet_news_used': 0.0,
        'planet_comic_used': 0.0,
        'planet_novel_used': 0.0,
        'game_used': 0.0,
        'gamapay_used': 0.0,
        'gash_used': 0.0
'''
...
ShowUser2ItemDINModelConfig = BaseDINConfigs.update({
    ...
    'DENSE_FEATURE_SIZE': {
            ...
            'user_title_embedding': 300, 'item_title_embedding': 300, 'club_user_title_embedding': 300
    },
    ...
    'DENSE_FEATURE': [
        ...
        'user_title_embedding', 'item_title_embedding', 'club_user_title_embedding'
    ],
})
...
ShowUser2ItemDINPreprocessConfig = BaseUser2ItemPreprocessConfigs.update({
    ...
    'COLUMN_TO_FILLNA': {
        ...
        'user_category': '{}',
        'cat0': lambda x: x if len(eval(x)) > 0 else [UNKNOWN_LABEL],
        'user_title_embedding': [0.0] * 300,
        'item_title_embedding': [0.0] * 300,
        'club_user_title_embedding': [0.0] * 300,
    ...
    'TYPE_CONVERT_MODE2COLS': {
        'ast': ['cat0', 'user_title_embedding', 'item_title_embedding', 'club_user_title_embedding'],

        'int64': ['publish_time', 'timestamp',
                  '1_last_day_total_view_count', '1_last_day_total_click_count',
                  '3_last_day_total_view_count', '3_last_day_total_click_count',
                  '5_last_day_total_view_count', '5_last_day_total_click_count'],
        'float' : ['planet_news_used', 'planet_comic_used', 'planet_novel_used',
                  'game_used', 'gamapay_used', 'gash_used']
    },
    ...
    # support min-max or z-score (Need to be optimized. Currently normalize method is too hacky)
                    #    '1_last_day_total_view_count': None, 
                    #'1_last_day_total_click_count': None,
                    #'3_last_day_total_view_count': None, 
                    #'3_last_day_total_click_count': None,
                    #'5_last_day_total_view_count': None, 
                    #'5_last_day_total_click_count': None},
    'NORMALIZE_COLS': {
    ...
    'REQUISITE_COLS': [
        ...
        '3_last_day_total_view_count', '3_last_day_total_click_count',
        '5_last_day_total_view_count', '5_last_day_total_click_count',
        'planet_news_used', 'planet_comic_used', 'planet_novel_used',
        'game_used', 'gamapay_used', 'gash_used', 
        'y']
})
