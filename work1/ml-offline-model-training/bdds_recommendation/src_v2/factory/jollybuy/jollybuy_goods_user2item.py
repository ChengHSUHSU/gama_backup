...
from bdds_recommendation.src_v2.configs.jollybuy_goods.jollybuy_goods_user2item import JollybuyGoodsUser2ItemDINConfig
from bdds_recommendation.src_v2.preprocess.jollybuy.jollybuy_goods_user2item import JollybuyGoodsUser2ItemDINPreprocessor
...
class JollybuyGoodsUser2ItemLearn2RankDINFactory(CTRRankerFactory):
    ...
    def initialize(self, mode: str, col2label2idx: dict = None, **kwargs):
        ...
        self.config = JollybuyGoodsUser2ItemDINConfig

        if mode == 'train':
            self.preprocessor = JollybuyGoodsUser2ItemDINPreprocessor(configs=self.config,
            ...
            self.model_handler.load_model(kwargs.get('model_path', '/ml-model/user2item/jollybuy/din/model.latest.pickle'))
