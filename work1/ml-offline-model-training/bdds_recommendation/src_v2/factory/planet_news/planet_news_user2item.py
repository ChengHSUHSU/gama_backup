...
from bdds_recommendation.src_v2.configs.planet_news.planet_news_user2item import PlanetNewsUser2ItemDINConfig
from bdds_recommendation.src_v2.preprocess.planet_news.planet_news_user2item import PlanetNewsUser2ItemDINPreprocessor
...
class PlanetNewsUser2ItemLearn2RankDINFactory(CTRRankerFactory):
