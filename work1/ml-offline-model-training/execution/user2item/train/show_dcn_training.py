...
from bdds_recommendation.src_v2.factory.show.show_user2item import ShowUser2ItemLearn2RankDCNFactory
...
if __name__ == '__main__':
    ...
    model_factory = ShowUser2ItemLearn2RankDCNFactory(mode='train', use_cuda=True, **vars(opt))
    ...
    if opt.monitoring:
        ...
        baseline_factory = ShowUser2ItemLearn2RankDCNFactory(mode='validation',
