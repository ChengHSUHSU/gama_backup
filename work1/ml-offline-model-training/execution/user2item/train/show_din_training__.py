...
from bdds_recommendation.src_v2.factory.show.show_user2item import ShowUser2ItemLearn2RankDINFactory
...
if __name__ == '__main__':
    ...
    model_factory = ShowUser2ItemLearn2RankDINFactory(mode='train', use_cuda=True, **vars(opt))
