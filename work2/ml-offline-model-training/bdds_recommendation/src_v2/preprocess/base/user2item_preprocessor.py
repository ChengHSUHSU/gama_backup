...
from bdds_recommendation.src.preprocess.utils import convert_type, read_pickle, normalize_data, process_time_period, merge_data_with_user
from bdds_recommendation.src.preprocess.utils.encoder import CategoricalEncoder
from bdds_recommendation.src_v2.preprocess.utils.preference import Preference
from bdds_recommendation.src_v2.preprocess.utils.din import get_behavior_feature
...
class BaseUser2ItemPreprocessor():
    ...
    def append_timestamp(self, dataset: pd.DataFrame, column_name: str = 'timestamp', **kwargs):

        dataset[column_name] = int(datetime.timestamp(datetime.utcnow()))*1000
