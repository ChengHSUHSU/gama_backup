...
from bdds_recommendation.src_v2.factory.planet_news.planet_news_item2item import PlanetNewsItem2ItemLearn2RankSGDFactory
...
if __name__ == '__main__':
    ...
    model_factory = PlanetNewsItem2ItemLearn2RankSGDFactory(mode='train', **vars(opt))
    ...
    if opt.monitoring:
        ...
        baseline_factory = PlanetNewsItem2ItemLearn2RankSGDFactory(mode='validation',
