...
if __name__ == '__main__':
    ...
    logger.info(f'[Planet Novel Book User2Item][Model Validation] opt: {vars(opt)}')
    ...
    if opt.save:
        ...
        for file_name, asset in assets_to_log.items():
            logger.info(f'[Planet Novel Book User2Item][MLFlow] Store {file_name}')
    ...
    if opt.monitoring:
        logger.info('[Planet Novel Book User2Item][Model Offline Monitoring] Start offline monitoring')
        ...
        logger.info(f'[Planet Novel Book User2Item][Model Offline Monitoring] Compare with version : {monitor.model_version}')
        ...
        logger.info(f'[Planet Novel Book User2Item][Model Validation] Baseline result \n{comparison_result}')
        logger.info('[Planet Novel Book User2Item][Model Offline Monitoring] Compute performance improvement rate')
        ...
        logger.info(f'[Planet Novel Book User2Item][Model Validation] Improvement Rate \n{comparison_result}')
        ...
        if len(alert_list) > 0:
            logger.info('[Planet Novel Book User2Item][Model Offline Monitoring] Send alert mail')
            ...
            logger.info('[Planet Novel Book User2Item][Model Offline Monitoring] No alert mail need to be sent')

        logger.info('[Planet Novel Book User2Item][Model Offline Monitoring] Logging validation result')
